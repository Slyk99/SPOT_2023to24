###########################################################################
## Makefile generated for component 'APF_Path_Planning_2023a_BlueIsBlack'. 
## 
## Makefile     : APF_Path_Planning_2023a_BlueIsBlack.mk
## Generated on : Mon Apr 01 17:55:49 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/APF_Path_Planning_2023a_BlueIsBlack.elf
...
PRODUCT_NAME              = APF_Path_Planning_2023a_BlueIsBlack
MAKEFILE                  = APF_Path_Planning_2023a_BlueIsBlack.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/APF_Path_Planning_2023a_BlueIsBlack.elf
...
DEFINES_STANDARD = -DMODEL=APF_Path_Planning_2023a_BlueIsBlack -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


APF_Path_Planning_2023a_BlueIsBlack.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/APF_Path_Planning_2023a_BlueIsBlack.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


APF_Path_Planning_2023a_BlueIsBlack_data.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/APF_Path_Planning_2023a_BlueIsBlack_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_BlueIsBlack_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
