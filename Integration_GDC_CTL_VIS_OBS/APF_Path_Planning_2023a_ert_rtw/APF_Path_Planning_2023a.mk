###########################################################################
## Makefile generated for component 'APF_Path_Planning_2023a'. 
## 
## Makefile     : APF_Path_Planning_2023a.mk
## Generated on : Fri Apr 05 15:08:03 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/APF_Path_Planning_2023a.elf
...
PRODUCT_NAME              = APF_Path_Planning_2023a
MAKEFILE                  = APF_Path_Planning_2023a.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/APF_Path_Planning_2023a.elf
...
DEFINES_STANDARD = -DMODEL=APF_Path_Planning_2023a -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


APF_Path_Planning_2023a.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/APF_Path_Planning_2023a.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


APF_Path_Planning_2023a_data.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/APF_Path_Planning_2023a_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.cpp.o : $(START_DIR)/APF_Path_Planning_2023a_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
