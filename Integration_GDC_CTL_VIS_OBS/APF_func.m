function [phi_tot,phi_tot_grad,u, state_desired] = APF_func(state_red,state_black,state_blue,shape,ka,kr,Q_a,Q_b,P_b,r_hold,Binv,K_a,psi,sigma,r_off,Nmat)

% state_desired = [state_black(1)+r_hold*cos(state_black(3))
%                  state_black(2)+r_hold*sin(state_black(3))
%                  state_black(3)+pi
%                  state_black(4)-r_hold*sin(state_black(3))*state_black(6)
%                  state_black(5)+r_hold*cos(state_black(3))*state_black(6)
%                  state_black(6)];
